...
import { Eye, User, Mail, Phone, Calendar, DollarSign, CreditCard, TrendingUp, Briefcase, GraduationCap, Building } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-sm text-gray-600">Increment</p>
                  <p className="font-medium">{extendedEmployee.increment || 'Not provided'}</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
